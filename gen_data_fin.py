...
def main():
    ...
    max_len = 0
    min_len = 100000
    if mode_name == "item-sequence":
        dataset = data_partition(output_dir + dataset_name + '.txt', mode_name)
        ...
        vocab = FreqVocab(user_test_data)  # ใช้ vocab แค่ user_test_data เพราะมันมีข้อมูลของทั้ง train และ test
        # print("vocab user test data",vocab.counter['item_1854'])
